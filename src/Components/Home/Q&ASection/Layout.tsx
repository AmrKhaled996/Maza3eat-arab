...
function HomeQandALayout({ children }: React.PropsWithChildren) {
  return (
        ...
        <div className="flex items-start sm:items-center justify-between mb-8 gap-4">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              احصل على اجوبة من المسافرين الخبراء
            </p>
          </div>
          <button
          ...
          >
           <CircleQuestionMarkIcon className="bg-white rounded-full p-0 m-0 text-accent" size={16} /> اطرح سؤال
          </button>
        </div>
        {children}
      </div>
