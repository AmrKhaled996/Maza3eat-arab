    ...
    <div className="h-[70vh] flex flex-col items-center justify-center ">
      ...
      <div className="text-center mb-10 ">
        <h1 className="text-4xl sm:text-4xl md:text-5xl font-extrabold text-gray-900 leading-tight mb-3">
          {t("FeaturedMainPage.subtitle").split('\n')[0]}
          <br />
          {t("FeaturedMainPage.subtitle").split('\n')[1]}
        </h1>
      </div>
      ...
      <div className="relative w-full max-w-xl mx-auto mb-12">
        <input
          ...
          placeholder={t("FeaturedMainPage.searchPlaceholder")}
        ...
        <button
          ...
          className={`absolute ${lang === "en" ? "right-3" : "left-3"} top-1/2 main-gradient -translate-y-1/2 w-8 h-8 rounded-full flex items-center justify-center text-white shadow hover:cursor-pointer` }
        >
          {searchLoading ? (
